<?php
    ...
    $insert_query ="INSERT INTO `regform`(`username`, `pass`, `email`, `mob`) VALUES ('$r_username','$r_pass','$r_email','$r_mobile')";
    
    $duplicate_username = mysqli_query($conn,"SELECT * FROM `regform` WHERE username='$r_username'");
    $duplicate_email = mysqli_query($conn,"SELECT * FROM `regform` WHERE email='$r_email'");
